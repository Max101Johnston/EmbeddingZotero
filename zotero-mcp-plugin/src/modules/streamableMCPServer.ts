    ...
    try {
      ...
      let message = !isReady
        ...
        : stats?.serviceStatus.fallbackMode
          ...
          : `Semantic search ready with ${stats?.libraryStats?.indexedRegularItems ?? stats?.indexStats.totalItems ?? 0} current indexed references`;
      ...
      return {
        ...
        libraryStats: stats?.libraryStats || null,
